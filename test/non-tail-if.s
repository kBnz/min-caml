...
min_caml_start:
	...
	cmp	%26, %0, 0
	sub	%26, 0, %26
	brle	bgt_else.144, %26
	add	%30, %29, 4
	ld	%1, %30
	add	%30, %29, 0
	ld	%2, %30
	cmp	%26, %2, 0
	brle	bgt_else.146, %26
	mov	%2, %0
	add	%1, %1, %2
	add	%30, %29, 4
	ld	%2, %30
